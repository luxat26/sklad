                    ...
                    {isEditing ? (
                        <div className="flex flex-col gap-2" onClick={(e) => e.stopPropagation()}>
                            <input 
                                ...
                                className="font-bold text-slate-800 bg-slate-50 border border-blue-300 rounded-lg px-2 py-1 text-sm w-full outline-none focus:ring-2 focus:ring-blue-200"
                                placeholder="Název"
                                autoFocus
                            />
                            <div className="flex items-center gap-2">
                                ...
                                <input 
                                    ...
                                    onChange={(e) => setEditValues({...editValues, box: e.target.value})}
                                    className="font-bold text-slate-800 bg-slate-50 border border-blue-300 rounded-lg px-2 py-0.5 text-xs w-20 outline-none focus:ring-2 focus:ring-blue-200"
                                    placeholder="Box"
                                />
                            </div>
                        </div>
                ...
                <div className="flex items-center gap-1 text-slate-300 pl-2">
                    {isEditing ? (
                        <div className="flex items-center gap-1">
                            ...
                            <button onClick={cancelEdit} className="p-2 bg-red-100 text-red-500 rounded-lg hover:bg-red-200 transition-colors">
                                <X className="w-4 h-4" />
                            </button>
                        </div>
                    ) : (
